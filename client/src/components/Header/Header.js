    ...
    <header className="bg-gray-800 text-light mb-2 py-1 flex-row align-center">
      <div className="container flex-row justify-space-between-lg justify-center align-center">
        <div>
          ...
          <p className="border mt-10 font-bold text-green-500 text-2xl rounded-full bg-black flex items-center justify-center font-mono">Get into the mind of a programmer.</p>
        </div>
        <div>
          {Auth.loggedIn() ? (
            <>
